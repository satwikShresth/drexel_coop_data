...
import AutocompleteSelect from '../components/form/autocomplete';
   ...
   try {
      ...
      const response = await fetch(
         !(query)
            ...
            : `http://localhost:8000/company?query=${query}`
      );
            ...
            ({ values, setFieldValue }) => (
               ...
               <Form className="max-w-2xl mx-auto p-4 bg-white shadow-md rounded-md">
                  <Field
                     ...
                     id="companyName"
                     optionsCallback={fetchCompanies}
                     placeholder="Select a company..."
                     noOptionsMessage="No company available. Start typing to search..."
                     required={true}
                     isCreatable={true}
                  />
                  ...
                  <Field
                     ...
                     noOptionsMessage="No location available. Start typing to search..."
